...
class CompletedTechServices extends StatelessWidget {
  const CompletedTechServices({Key? key}) : super(key: key);
        ...
        body: Container(
          ...
          child: ListView.builder(
            itemBuilder: (__, index) {
              TechScheduledService? service =
                  _.completedScheduledServices[index];
              return ListTile(
            ...
            itemCount: _.completedScheduledServices.length,
          ),
        ),
      ),
    );
