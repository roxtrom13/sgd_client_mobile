...
import 'package:sgd_client_mobile/controllers/service_tech_detail_controller.dart';
import 'package:sgd_client_mobile/screens/chat_page.dart';

class ServiceTechDetail extends StatelessWidget {
  const ServiceTechDetail({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ServiceTechDetailController>(
      init: ServiceTechDetailController(),
      builder: (_) => Scaffold(
        appBar: AppBar(
          leading: IconButton(
            icon: Icon(
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                            '${_.service.client.firstName} ${_.service.client.lastName}'),
                        SizedBox(height: 15),
                        Text('Número de contacto:', style: titleStyle),
                        Text(_.service.client.phone),
                        SizedBox(height: 15),
                      ],
                    ),
                  ),
